 ...
 */
public class LongGoalState implements GoalState {
    ...
    final private LongGoalConfiguration configuration;
    final private GoalContext context;
    private String status;

    @JsonCreator
    public LongGoalState(
        @JsonProperty("goalKey") String goalKey,
        @JsonProperty("player") String player,
        @JsonProperty("bank") Bank bank,
        @JsonProperty("goal") String goal,
        @JsonProperty("configuration") LongGoalConfiguration configuration,
    ...
    @Override
    public LongGoalConfiguration getConfiguration() {
    ...
    public boolean equals(Object o) {
        ...
        LongGoalState that = (LongGoalState) o;
