 ...
 */
public abstract class GoalJudgeInvitationWebMapping implements WebMapping {

    final private static String GOAL_JUDGE_INVITATIO_URL = "http://{host}//goal/judge";
    ...
    public static String toGoalJudgeInvitationUrl(String path) {
        return GOAL_JUDGE_INVITATIO_URL + path;
    }
