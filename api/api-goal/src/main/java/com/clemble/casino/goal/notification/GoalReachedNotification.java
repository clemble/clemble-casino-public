 ...
 */
@JsonTypeName(GoalReachedNotification.JSON_TYPE)
public class GoalReachedNotification implements GoalNotification{
    ...
    @JsonCreator
    public GoalReachedNotification(
    ...
    public static GoalReachedNotification create(GoalState state) {
        return new GoalReachedNotification(
            state.getGoalKey(),
            state.getPlayer(),
            state.getBank(),
            state.getGoal(),
    ...
    public boolean equals(Object o) {
        ...
        GoalReachedNotification that = (GoalReachedNotification) o;
