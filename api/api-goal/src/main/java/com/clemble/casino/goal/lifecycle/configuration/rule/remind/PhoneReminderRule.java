 ...
 */
public class PhoneReminderRule implements RemindRule {

    final private long reminder;

    @JsonCreator
    public PhoneReminderRule(@JsonProperty("reminder") long reminder) {
    ...
    public boolean equals(Object o) {
        ...
        PhoneReminderRule that = (PhoneReminderRule) o;
