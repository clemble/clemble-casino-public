...
public class PaymentJsonModuleGenerator {

    final private static String MODULE = "Payment";

    @Test
    public void findCandidates() {
        Collection<Class<?>> candidates = AnnotationReflectionUtils.findCandidates("com.clemble.casino.payment", JsonTypeName.class);
