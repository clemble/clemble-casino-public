...
public class AccessGrant implements Serializable {
    ...
    @JsonCreator
    public AccessGrant(@JsonProperty("accessToken") String accessToken, @JsonProperty("scope") String scope, @JsonProperty("refreshToken") String refreshToken, @JsonProperty("expiresTime") Long expiresIn) {
